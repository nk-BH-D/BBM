...
import (
	...
	"github.com/nikitakutergin59/calculator/equations" // реализует пакет telegram
...
func main() {
	botToken := os.Getenv("BOT_TOKEN") // при запуске в cmd прописываеться команда "set BOT_TOKEN=токен выданный телегой", а потом уже запуст, но ещё можно пакетным файлом
